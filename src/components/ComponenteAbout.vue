...
<template>
  <div class="card-container">
    <img
      class="round"
      src="./icons/WhatsApp Image 2024-06-28 at 23.26.49.jpeg"
      alt="user"
    />
    <h3>Juan Pablo Batallón Costa</h3>
    <h6>Pergamino, Bs. As., Argentina</h6>
    <p>Estudiante en programación.</p>
    <p>Trainee en Python.</p>
    <div class="buttons">
...
.button-content {
  ...
  align-items: center;
  justify-content: center;
  background: linear-gradient(135deg, #36a8fa, #ff0f7b);
  color: white;
  padding: 14px 28px;
  border-radius: 50px;
  cursor: pointer;
